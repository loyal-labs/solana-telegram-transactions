...
function findBufferPda(account, delegationProgramId = DELEGATION_PROGRAM_ID) {
  return PublicKey2.findProgramAddressSync([Buffer.from("buffer"), account.toBuffer()], delegationProgramId);
}
