...
export declare const isSyncPayloadTransaction: (x: SyncPayload) => x is SyncPayload & {
    __kind: "Transaction";
};
export declare const isSyncPayloadPolicy: (x: SyncPayload) => x is SyncPayload & {
    __kind: "Policy";
};
/**
 * @category userTypes
 * @category generated
 */
export declare const syncPayloadBeet: beet.FixableBeet<SyncPayload, SyncPayload>;
