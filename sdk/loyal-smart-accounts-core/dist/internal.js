...
// src/internal/instructions/index.ts
var exports_instructions = {};
__export(exports_instructions, {
  useSpendingLimit: () => useSpendingLimit2,
  setTimeLockAsAuthority: () => setTimeLockAsAuthority2,
  setProgramConfigTreasury: () => setProgramConfigTreasury2,
  setProgramConfigSmartAccountCreationFee: () => setProgramConfigSmartAccountCreationFee2,
  setProgramConfigAuthority: () => setProgramConfigAuthority2,
  setNewSettingsAuthorityAsAuthority: () => setNewSettingsAuthorityAsAuthority2,
  setArchivalAuthorityAsAuthority: () => setArchivalAuthorityAsAuthority2,
  removeSpendingLimitAsAuthority: () => removeSpendingLimitAsAuthority2,
  removeSignerAsAuthority: () => removeSignerAsAuthority2,
  rejectProposal: () => rejectProposal2,
  logEvent: () => logEvent2,
  initializeProgramConfig: () => initializeProgramConfig2,
  extendTransactionBuffer: () => extendTransactionBuffer2,
  executeTransactionSyncV2: () => executeTransactionSyncV22,
  executeTransactionSync: () => executeTransactionSync2,
  executeTransaction: () => executeTransaction2,
  executeSettingsTransactionSync: () => executeSettingsTransactionSync2,
  executeSettingsTransaction: () => executeSettingsTransaction2,
  executePolicyTransaction: () => executePolicyTransaction,
  executePolicyPayloadSync: () => executePolicyPayloadSync,
  executeBatchTransaction: () => executeBatchTransaction2,
  createTransactionFromBuffer: () => createTransactionFromBuffer2,
  createTransactionBuffer: () => createTransactionBuffer2,
  createTransaction: () => createTransaction2,
  createSmartAccount: () => createSmartAccount2,
  createSettingsTransaction: () => createSettingsTransaction2,
  createProposal: () => createProposal2,
  createPolicyTransaction: () => createPolicyTransaction,
  createBatch: () => createBatch2,
  closeTransactionBuffer: () => closeTransactionBuffer2,
  closeTransaction: () => closeTransaction2,
  closeSettingsTransaction: () => closeSettingsTransaction2,
  closeEmptyPolicyTransaction: () => closeEmptyPolicyTransaction2,
  closeBatchTransaction: () => closeBatchTransaction2,
  closeBatch: () => closeBatch2,
  changeThresholdAsAuthority: () => changeThresholdAsAuthority2,
  cancelProposal: () => cancelProposal2,
  approveProposal: () => approveProposal2,
  addTransactionToBatch: () => addTransactionToBatch2,
  addSpendingLimitAsAuthority: () => addSpendingLimitAsAuthority2,
  addSignerAsAuthority: () => addSignerAsAuthority2,
  activateProposal: () => activateProposal2
});
...
// src/internal/instructions/closeBatch.ts
function closeBatch2({
  settingsPda,
  batchRentCollector,
  batchIndex,
  programId = PROGRAM_ID,
...
// src/internal/instructions/addTransactionToBatch.ts
function addTransactionToBatch2({
  accountIndex,
  settingsPda,
  signer,
  rentPayer,
...
// src/internal/instructions/createBatch.ts
...
// src/internal/instructions/executeBatchTransaction.ts
async function executeBatchTransaction2({
  connection,
  settingsPda,
  signer,
  batchIndex,
  ...
  const batchTransactionAccount = await BatchTransaction.fromAccountAddress(connection, batchTransactionPda);
...
// src/internal/instructions/initializeProgramConfig.ts
var import_bn = __toESM(require_bn(), 1);
function initializeProgramConfig2({
  initializer,
  authority,
  smartAccountCreationFee,
  treasury,
  ...
  return createInitializeProgramConfigInstruction({
    ...
    args: {
      authority,
      smartAccountCreationFee: new import_bn.default(smartAccountCreationFee.toString()),
      treasury
    }
  }, programId);
}
// src/internal/instructions/setProgramConfigAuthority.ts
function setProgramConfigAuthority2({
  authority,
  newAuthority,
  programId = PROGRAM_ID
}) {
...
// src/internal/instructions/setProgramConfigSmartAccountCreationFee.ts
var import_bn2 = __toESM(require_bn(), 1);
function setProgramConfigSmartAccountCreationFee2({
  authority,
  smartAccountCreationFee,
  programId = PROGRAM_ID
}) {
  ...
  return createSetProgramConfigSmartAccountCreationFeeInstruction({
    ...
    args: {
      newSmartAccountCreationFee: new import_bn2.default(smartAccountCreationFee.toString())
    }
  }, programId);
}
// src/internal/instructions/setProgramConfigTreasury.ts
function setProgramConfigTreasury2({
  authority,
  treasury,
  programId = PROGRAM_ID
}) {
...
// src/internal/instructions/closeSettingsTransaction.ts
function closeSettingsTransaction2({
  settingsPda,
...
// src/internal/instructions/createSettingsTransaction.ts
function createSettingsTransaction2({
  settingsPda,
  transactionIndex,
  creator,
  rentPayer,
...
// src/internal/instructions/executeSettingsTransaction.ts
import { SystemProgram as SystemProgram15 } from "@solana/web3.js";
function executeSettingsTransaction2({
  settingsPda,
  transactionIndex,
  signer,
  rentPayer,
...
// src/internal/instructions/executeSettingsTransactionSync.ts
import { SystemProgram as SystemProgram16 } from "@solana/web3.js";
function executeSettingsTransactionSync2({
  settingsPda,
  signers,
  actions,
  feePayer,
...
// src/internal/instructions/createSmartAccount.ts
import {
  PublicKey as PublicKey57
} from "@solana/web3.js";
function createSmartAccount2({
  treasury,
  creator,
  settings,
  settingsAuthority,
  ...
  const settingsAccountMeta = {
    pubkey: settings ?? PublicKey57.default,
    isSigner: false,
    isWritable: true
  };
...
// src/internal/instructions/addSignerAsAuthority.ts
import { SystemProgram as SystemProgram17 } from "@solana/web3.js";
function addSignerAsAuthority2({
  settingsPda,
  settingsAuthority,
  rentPayer,
  newSigner,
  ...
  return createAddSignerAsAuthorityInstruction({
    ...
    program: programId
  }, { args: { newSigner, memo: memo ?? null } }, programId);
}
// src/internal/instructions/removeSignerAsAuthority.ts
import { SystemProgram as SystemProgram18 } from "@solana/web3.js";
function removeSignerAsAuthority2({
  settingsPda,
  settingsAuthority,
  oldSigner,
  memo,
  ...
  return createRemoveSignerAsAuthorityInstruction({
    ...
    program: programId
  }, { args: { oldSigner, memo: memo ?? null } }, programId);
}
// src/internal/instructions/addSpendingLimitAsAuthority.ts
var import_bn3 = __toESM(require_bn(), 1);
import { SystemProgram as SystemProgram19 } from "@solana/web3.js";
function addSpendingLimitAsAuthority2({
  settingsPda,
  settingsAuthority,
  spendingLimit,
  rentPayer,
  ...
  return createAddSpendingLimitAsAuthorityInstruction({
    ...
    args: {
      ...
      accountIndex,
      mint,
      amount: new import_bn3.default(amount.toString()),
      period,
      signers,
      destinations,
      expiration: expiration ? new import_bn3.default(expiration) : new import_bn3.default("9223372036854775807"),
      memo: memo ?? null
    }
  }, programId);
}
// src/internal/instructions/changeThresholdAsAuthority.ts
function changeThresholdAsAuthority2({
  settingsPda,
  settingsAuthority,
  rentPayer,
  newThreshold,
...
// src/internal/instructions/removeSpendingLimitAsAuthority.ts
function removeSpendingLimitAsAuthority2({
  settingsPda,
  settingsAuthority,
  spendingLimit,
  rentCollector,
...
// src/internal/instructions/setNewSettingsAuthorityAsAuthority.ts
function setNewSettingsAuthorityAsAuthority2({
  settingsPda,
  settingsAuthority,
...
// src/internal/instructions/setArchivalAuthorityAsAuthority.ts
import { SystemProgram as SystemProgram20 } from "@solana/web3.js";
function setArchivalAuthorityAsAuthority2({
  settingsPda,
  settingsAuthority,
  ...
  return createSetArchivalAuthorityAsAuthorityInstruction({
    settings: settingsPda,
    settingsAuthority,
    systemProgram: SystemProgram20.programId,
    program: programId
  }, {
    args: {
      newArchivalAuthority,
...
// src/internal/instructions/setTimeLockAsAuthority.ts
function setTimeLockAsAuthority2({
  settingsPda,
  settingsAuthority,
  timeLock,
  memo,
...
// src/internal/instructions/activateProposal.ts
function activateProposal2({
  settingsPda,
  transactionIndex,
  signer,
  programId = PROGRAM_ID
...
// src/internal/instructions/approveProposal.ts
function approveProposal2({
  settingsPda,
  transactionIndex,
  signer,
  memo,
  ...
  return createApproveProposalInstruction({ consensusAccount: settingsPda, proposal: proposalPda, signer, program: programId }, { args: { memo: memo ?? null } }, programId);
}
// src/internal/instructions/cancelProposal.ts
import { SystemProgram as SystemProgram21 } from "@solana/web3.js";
function cancelProposal2({
  settingsPda,
  transactionIndex,
  signer,
  memo,
  ...
  return createCancelProposalInstruction({ consensusAccount: settingsPda, proposal: proposalPda, signer, systemProgram: SystemProgram21.programId, program: programId }, { args: { memo: memo ?? null } }, programId);
}
// src/internal/instructions/createProposal.ts
...
// src/internal/instructions/rejectProposal.ts
function rejectProposal2({
  settingsPda,
  transactionIndex,
  signer,
  memo,
  ...
  return createRejectProposalInstruction({
    ...
    signer,
    program: programId
  }, { args: { memo: memo ?? null } }, programId);
}
// src/internal/instructions/useSpendingLimit.ts
import {
  SystemProgram as SystemProgram22
} from "@solana/web3.js";
import {
...
function useSpendingLimit2({
  ...
  const smartAccountTokenAccount = mint && getAssociatedTokenAddressSync(mint, smartAccountPda, true, tokenProgram, ASSOCIATED_TOKEN_PROGRAM_ID);
  const destinationTokenAccount = mint && getAssociatedTokenAddressSync(mint, destination, true, tokenProgram, ASSOCIATED_TOKEN_PROGRAM_ID);
  return createUseSpendingLimitInstruction({
    ...
    destination,
    systemProgram: SystemProgram22.programId,
    mint,
...
// src/internal/instructions/closeBatchTransaction.ts
function closeBatchTransaction2({
  settingsPda,
  transactionRentCollector,
  batchIndex,
  transactionIndex,
...
// src/internal/instructions/closeTransaction.ts
function closeTransaction2({
  settingsPda,
  transactionRentCollector,
  transactionIndex,
  programId = PROGRAM_ID,
...
// src/internal/instructions/createTransaction.ts
...
// src/internal/instructions/createTransactionBuffer.ts
function createTransactionBuffer2({
  consensusPda,
  creator,
  rentPayer,
  bufferIndex,
...
// src/internal/instructions/closeTransactionBuffer.ts
function closeTransactionBuffer2({
  consensusPda,
  creator,
  bufferIndex,
  transactionBuffer,
...
// src/internal/instructions/extendTransactionBuffer.ts
function extendTransactionBuffer2({
  consensusPda,
  creator,
  bufferIndex,
  buffer,
...
// src/internal/instructions/createTransactionFromBuffer.ts
import { SystemProgram as SystemProgram23 } from "@solana/web3.js";
var EMPTY_TRANSACTION_MESSAGE = new Uint8Array(6).fill(0);
function createTransactionFromBuffer2({
  consensusPda,
  creator,
  rentPayer,
  transactionIndex,
  ...
  return createCreateTransactionFromBufferInstruction({
    ...
    transactionCreateItemSystemProgram: SystemProgram23.programId,
...
// src/internal/instructions/executeTransaction.ts
async function executeTransaction2({
  ...
  const transactionAccount = await Transaction.fromAccountAddress(connection, transactionPda);
...
// src/internal/instructions/executeTransactionSync.ts
function executeTransactionSync2({
  settingsPda,
  accountIndex,
  numSigners,
  instructions: instructions2,
...
// src/internal/instructions/createPolicyTransaction.ts
...
// src/internal/instructions/executePolicyTransaction.ts
function executePolicyTransaction({
  policy,
  transactionIndex,
  signer,
  anchorRemainingAccounts,
...
// src/internal/instructions/executeTransactionSyncV2.ts
function executeTransactionSyncV22({
  settingsPda,
  accountIndex,
  numSigners,
  instructions: instructions2,
  ...
  const ix = createExecuteTransactionSyncV2Instruction({
    ...
    args: {
      ...
      payload: {
        __kind: "Transaction",
        fields: [instructions2]
      }
    }
  }, programId);
  return ix;
}
// src/internal/instructions/executePolicyPayloadSync.ts
function executePolicyPayloadSync({
  policy,
  accountIndex,
  numSigners,
  policyPayload,
...
// src/internal/instructions/closeEmptyPolicyTransaction.ts
function closeEmptyPolicyTransaction2({
  emptyPolicy,
  transactionRentCollector,
  transactionIndex,
  programId = PROGRAM_ID
...
// src/internal/instructions/logEvent.ts
function logEvent2({
  logAuthority,
  event,
  programId = PROGRAM_ID
...
export {
  useSpendingLimit2 as useSpendingLimit,
  setTimeLockAsAuthority2 as setTimeLockAsAuthority,
  setProgramConfigTreasury2 as setProgramConfigTreasury,
  setProgramConfigSmartAccountCreationFee2 as setProgramConfigSmartAccountCreationFee,
  setProgramConfigAuthority2 as setProgramConfigAuthority,
  setNewSettingsAuthorityAsAuthority2 as setNewSettingsAuthorityAsAuthority,
  setArchivalAuthorityAsAuthority2 as setArchivalAuthorityAsAuthority,
  removeSpendingLimitAsAuthority2 as removeSpendingLimitAsAuthority,
  removeSignerAsAuthority2 as removeSignerAsAuthority,
  rejectProposal2 as rejectProposal,
  logEvent2 as logEvent,
  exports_instructions as instructions,
  initializeProgramConfig2 as initializeProgramConfig,
  extendTransactionBuffer2 as extendTransactionBuffer,
  executeTransactionSyncV22 as executeTransactionSyncV2,
  executeTransactionSync2 as executeTransactionSync,
  executeTransaction2 as executeTransaction,
  executeSettingsTransactionSync2 as executeSettingsTransactionSync,
  executeSettingsTransaction2 as executeSettingsTransaction,
  executePolicyTransaction,
  executePolicyPayloadSync,
  executeBatchTransaction2 as executeBatchTransaction,
  createTransactionFromBuffer2 as createTransactionFromBuffer,
  createTransactionBuffer2 as createTransactionBuffer,
  createTransaction2 as createTransaction,
  createSmartAccount2 as createSmartAccount,
  createSettingsTransaction2 as createSettingsTransaction,
  createProposal2 as createProposal,
  createPolicyTransaction,
  createBatch2 as createBatch,
  closeTransactionBuffer2 as closeTransactionBuffer,
  closeTransaction2 as closeTransaction,
  closeSettingsTransaction2 as closeSettingsTransaction,
  closeEmptyPolicyTransaction2 as closeEmptyPolicyTransaction,
  closeBatchTransaction2 as closeBatchTransaction,
  closeBatch2 as closeBatch,
  changeThresholdAsAuthority2 as changeThresholdAsAuthority,
  cancelProposal2 as cancelProposal,
  approveProposal2 as approveProposal,
  addTransactionToBatch2 as addTransactionToBatch,
  addSpendingLimitAsAuthority2 as addSpendingLimitAsAuthority,
  addSignerAsAuthority2 as addSignerAsAuthority,
  activateProposal2 as activateProposal
};
